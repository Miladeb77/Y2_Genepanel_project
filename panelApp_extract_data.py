...
def setup_logging(script_dir, info_log_file="info_log.log", error_log_file="error_log.log"):
    """
...
def process_panel_data(panels, panels_url, headers):
    ...
    for i, panel in enumerate(panels, start=1):
        ...
        panel_info = {
            ...
            "version_created": panel_details["version_created"],
            ...
            "types": [ptype.get("name") for ptype in panel_details.get("types", [])],
        }
