...
def load_patient_data(databases_dir, patient_data_file):
    ...
    if os.path.exists(patient_data_path):
        ...
        try:
            ...
            logging.error(
                f"Failed to load patient data from {patient_data_path}: {e}"
            )
            raise
    else:
        logging.info(
            f"No patient data file found at {patient_data_path}. Using generated data."
        )
        return None


def generate_patient_database(
    num_patients, patient_data, clinical_ids=None, default_test_date=None
):
    """
    ...
    Args:
        ...
        patient_data (list): User-provided patient data.
        clinical_ids (list, optional): List of clinical IDs. Defaults to None.
        default_test_date (str, optional): Default test date. Defaults to None.
    ...
    # If clinical IDs are not provided, use the default list.
    if clinical_ids is None:
        clinical_ids = [
            'R169', 'R419', 'R56', 'R60', 'R62', 'R58', 'R233', 'R39', 'R293',
            'R106', 'R330', 'R340', 'R414', 'R446', 'R133', 'R83', 'R295',
            'R201', 'R19', 'R155', 'R413', 'R167', 'R422', 'R107', 'R391',
            'R49.3', 'R31', 'R90', 'R43', 'R128', 'R337', 'R319', 'R156',
            'R129', 'R333', 'R87', 'R336', 'R57', 'R61', 'R109', 'R359',
            'R171', 'R415', 'R124', 'R123', 'R99', 'R229, R258', 'R180',
            'R150', 'R46', 'R144', 'R145', 'R79', 'R80', 'R81', 'R262',
            'R237', 'R184', 'R193', 'R334', 'R91', 'R449', 'R450', 'R451',
            'R364', 'R146', 'R132', 'R73', 'R59', 'R163', 'R101', 'R140',
            'R217', 'R255', 'R164', 'R335', 'R345', 'R112', 'R118', 'R115',
            'R116', 'R117', 'R119', 'R120', 'R122', 'R324', 'R329', 'R134',
            'R151', 'R153', 'R254', 'R358', 'R162', 'R221', 'R21, R412',
            'R365', 'R272', 'R384', 'R142', 'R274', 'R273', 'R288', 'R194',
            'R361', 'R232', 'R18', 'R436', 'R341', 'R55, R84', 'R54', 'R215',
            'R405', 'R186', 'R440', 'R78', 'R204', 'R177', 'R85', 'R86',
            'R182', 'R131', 'R148', 'R154', 'R69', 'R165', 'R239', 'R208',
            'R210', 'R207', 'R367', 'R226', 'R223', 'R211', 'R347', 'R363',
            'R430', 'R224', 'R366', 'R29', 'R331', 'R157', 'R96', 'R280',
            'R281', 'R139', 'R41.3, R42.1', 'R216', 'R98', 'R82', 'R158',
            'R127', 'R17', 'R325', 'R276', 'R371', 'R197', 'R396', 'R353',
            'R354', 'R355', 'R356', 'R357', 'R352', 'R317', 'R394', 'R338',
            'R141', 'R67', 'R453', 'R327', 'R289', 'R277', 'R278', 'R291',
            'R292', 'R287', 'R290', 'R417.2', 'R218', 'R390', 'R230', 'R351',
            'R143', 'R143.1', 'R256', 'R222', 'R231', 'R271', 'R313', 'R214',
            'R444', 'R282', 'R380', 'R259.2', 'R168', 'R41', 'R102', 'R104.4',
            'R381', 'R27', 'R135', 'R438', 'R166', 'R175', 'R66', 'R212',
            'R283', 'R236', 'R159', 'R190', 'R315', 'R173', 'R63', 'R344',
            'R15', 'R136', 'R160', 'R328', 'R195', 'R420', 'R213', 'R426',
            'R188', 'R421', 'R316', 'R92', 'R332', 'R100', 'R198', 'R189',
            'R32', 'R219', 'R285', 'R235', 'R376', 'R110', 'R16', 'R234',
            'R149', 'R88', 'R130', 'R52', 'R323', 'R104', 'R76', 'R270',
            'R71', 'R38', 'R45', 'R36', 'R424', 'R138, R425', 'R192', 'R416',
            'R286', 'R93', 'R25', 'R395', 'R125', 'R406', 'R97', 'R228',
            'R202', 'R441', 'R257', 'R284', 'R170', 'R326', 'R225', 'R121',
            'R220', 'R172', 'R20', 'R227',
        ]
    ...
    if patient_data:
        ...
        # Generate random patient data if no user-provided data exists.
        ...
        for _ in range(num_patients):
            ...
            test_date = (
                start_of_year + timedelta(days=random_days)
            ).strftime("%Y-%m-%d")
            patients.append(
                {
                    "patient_id": patient_id,
...
def save_to_database(df, databases_dir, database_name, table_name="patient_data"):
    ...
    Args:
        ...
        table_name (str): Name of the table to save data to. Defaults to "patient_data".
    """
    try:
...
def parse_arguments():
    ...
    # JSON file containing patient data
    parser.add_argument(
        "--patient_data_file",
        type=str,
        default=None,
    ...
    # Default test date for generated patients
    parser.add_argument(
        "--default_test_date",
        type=str,
        default=None,
